...
# 밀도 목표 — 정본 real_baseline.json(make_real_baseline.py 생성)의 실사진 GM
# 크롭 밴드 밖 엣지 밀도값 전체(n=264, frame_exc 0, 2026-09-12 재측정).
# 렌더마다 여기서 재표본한다. 값 목록을 이 파일에 베끼지 않는다 — 라벨이
# 늘면 정본을 다시 생성하는 것으로 끝나야 한다.
