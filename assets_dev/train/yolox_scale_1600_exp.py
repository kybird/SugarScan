"""합성 밴드 검출기 — 규모 곡선 N=1600 (방향별 1600장, 학습 3200장).
...
스텝 예산 7350 은 여섯이 모두 같고 v2 와도 같다.
    ...
    서로 다른 이미지 3200장 x 반복 2 = 에포크당 6400개 항목
...
오르고 있으면 곡선의 꼭대기가 과소평가된 것이고, 예산을 다시 잡아야 한다.
    ...
    python D:/tmp/YOLOX/tools/train.py         -f D:/Project/sugarScan/assets_dev/train/yolox_scale_1600_exp.py         -d 1 -b 16 --fp16 -expn scale_1600         -c D:/Project/sugarScan/assets_dev/train/weights/yolox_nano.pth
"""
...
class Exp(BaseSynthbandExp):
    def __init__(self):
        ...
        self.train_ann = "instances_train_1600.json"
        self.val_ann = "instances_val2017.json"
        self.exp_name = "scale_1600"
